 ...
 * @type {Object}
 */
enchant.ui = { assets: ['pad.png', 'jump_pad.png', 'icon0.png', 'font0.png'] };
...
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
    ...
    initialize: function() {
        ...
        // var image = core.assets['arrow.png'];
...
enchant.ui.JumpPad = enchant.Class.create(enchant.Sprite, {
    /**
     * 方向キーパッドオブジェクトを作成する。
     * @constructs
     * @extends enchant.Sprite
    ...
    initialize: function() {
        var core = enchant.Core.instance;
        var image = core.assets['jump_pad.png'];
        enchant.Sprite.call(this, image.width / 2, image.height);
        this.image = image;
        this.input = { left: false, right: false, up: false, down: false };
        this.addEventListener('touchstart', function(e) {
